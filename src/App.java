...
class App {
  public static void main(String[] args) {// PARA SIMPLIFICAÇÃO, APENAS DOIS JOGADORES EM CADA EQUIPE
    ...
    // ENTÃO, FECHE OS SETS DO SEGUNDO E TERCEIRO JOGOS A SEGUIR DE MODO QUE TENHAM
    // UM VENCEDOR E LOGO O TORNEIO TENHA UM VENCEDOR A TUA ESCOLHA
    Jogo jogo2 = torneio.getJogo(2);
    jogo2.fecharSet(25, 2);
    jogo2.fecharSet(25, 5);
    jogo2.fecharSet(25, 6);
    Jogo jogo3 = torneio.getJogo(3);
    jogo3.fecharSet(10, 25);
    jogo3.fecharSet(15, 25);
    jogo3.fecharSet(20, 25);

    // E O VENCEDOR É:
    System.out.println(torneio.getVencedorTorneio().equals(azul));
  }
}
